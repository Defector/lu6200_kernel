...
//                                                                       
	...
	GPIO_CFG(GPIO_CAM_I2C_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(GPIO_CAM_I2C_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
#else
...
//                                                                                          
#if defined(CONFIG_MACH_LGE_325_BOARD_VZW)
static struct msm_gpio_set_tbl camera_gpio_set_tbl_mt9e013[] = {
	{GPIO_CAM_I2C_SDA, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_CAM_I2C_SCL, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_VT_CAM_RESET_N, GPIOF_OUT_INIT_LOW, 1000},
};

static struct msm_gpio_set_tbl camera_gpio_set_tbl_mt9m114[] = {
	{GPIO_CAM_I2C_SDA, GPIOF_OUT_INIT_LOW, 1000},
};
#endif
//                                                                                        
...
static struct msm_camera_gpio_conf gpio_conf_mt9e013 = {
	...
	.gpio_no_mux = 1,
#if defined(CONFIG_MACH_LGE_325_BOARD_VZW) //                                                                                    
	.cam_gpio_set_tbl = camera_gpio_set_tbl_mt9e013,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(camera_gpio_set_tbl_mt9e013),
#endif
};
...
#if defined(CONFIG_MACH_LGE_325_BOARD_VZW) //                                                                                 
	{"8058_l8", REG_LDO, 2650000, 2650000, -1},
#else
...
//                                                                                    
#if defined(CONFIG_MACH_LGE_325_BOARD_VZW)
	.cam_gpio_set_tbl = camera_gpio_set_tbl_mt9m114,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(camera_gpio_set_tbl_mt9m114),
#endif
};
