...
#include "timpani_profile_8x60_lge_325_lgu.h"
...
int audio_subsystem_renewal(void)
{
    ...
    const char* AudioSubsystemPath2 = "/etc/wm9093_325_lgu.txt";
#else
...
int get_wm9093_cal_db(char *data_array)
{
    ...
    /* Header */
    sprintf(str, "WM9093 for %s", "F100L");
...
{
#ifdef CONFIG_LGE_AUDIO_AMP_WM9093
    const char* AudioSubsystemPath  = "/data/wm9093_325_lgu.txt";
#else
    const char* AMPDefaultFilename = "/etc/amp.txt";
#endif /*                             */
    struct file *filp;
