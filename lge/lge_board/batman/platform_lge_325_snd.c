...
#include "timpani_profile_8x60_lge_325.h"
...
wmCodecCmd seq_lin_to_spkout[] = 
{
  ...
  {0x01,    0x000B},
  {0x02,    0x6020},
    {0x1A,    0x0101},//IN2A vol
  {0x36,    0x0004},
  {0x03,    0x0008},
  {0x22,    0x0000},
  {0x03,    0x0108},
    {0x25,    0x0170},//boost vol
    {0x26,    0x013C},//vol
  {0x17,    0x0002},
  {0x01,    0x100B},
#else
...
wmCodecCmd seq_lin_to_spkout_playback[] = 
{
  ...
  {0x01,    0x100B},
    ...
    {0x22, 0x0000}, // 0dB
    {0x03, 0x0108},  
    {0x25, 0x0160}, // 12dB(178}, 9dB(170}, 7.5dB(168}, 6dB(160}, 4.5dB(158}, 3dB(150}, 1.5dB(148}, 0dB(140)
    {0x26, 0x013C},  
    {0x17, 0x0000},  
    {0x01, 0x100B}
#endif
...
wmCodecCmd seq_lin_to_headset_spkout[] = 
{
    ...
    {0x2F, 0x0000},	
    {0x30, 0x0000},	
    {0x1C, 0x011D}, //refer to page 26
    {0x1D, 0x011D}, //refer to page 26    
    {0x16, 0x0000},	
    {0x46, 0x0100},	
    {0x49, 0x0100}
};
