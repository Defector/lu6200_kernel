...
static int power_set_for_8058_l15(unsigned char onoff)
{
	...
	if (onoff) {
		...
		rc = regulator_set_voltage(pm8058_l15, 2800000, 2800000);
#else
...
static struct apds9900_platform_data proximity_pdata = {
  ...
  .ppcount = 3,
	...
	.df_value = 52,
	.atime = 0xDE,
#elif defined(CONFIG_MACH_LGE_325_BOARD_SKT)
	.ppcount = 3,//4,
	.B = 1939,//1870,
	.C = 687,//0736,
	.D = 1293,//1330,
...
#ifdef CONFIG_MACH_LGE_325_BOARD_SKT
...
dcompss_pdata.fdata_order2 = 2;
	...
	gyroscope_pdata.axis_map_x = 0;
	gyroscope_pdata.axis_map_y = 1;
	gyroscope_pdata.axis_map_z = 2;
	gyroscope_pdata.negate_x = 0;
	gyroscope_pdata.negate_y = 0;
	gyroscope_pdata.negate_z = 0;
