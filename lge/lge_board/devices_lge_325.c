...
static int __init board_revno_setup(char *rev_info)
{
	...
	char *rev_str[] = {"evb1", "evb2", "rev_a", "rev_b", "rev_c", "rev_d",
		...
		"rev_13", "rev_14", "rev_15", "rev_16", "rev_17", "rev_18", "rev_19", // WBT 442513
		"revserved"};
	int i;
  ...
  lge_bd_target = LGE_325_BOARD_DCM;
#endif
#ifdef CONFIG_MACH_LGE_325_BOARD_SKT
  lge_bd_target = LGE_325_BOARD_SKT;
#endif
#ifdef CONFIG_MACH_LGE_325_BOARD_LGU
  lge_bd_target = LGE_325_BOARD_LGU;
#endif
#ifdef CONFIG_MACH_LGE_325_BOARD_VZW
  lge_bd_target = LGE_325_BOARD_VZW;
#endif
